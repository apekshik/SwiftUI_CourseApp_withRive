...
struct TabBar: View {
    ...
    // icon is purposely a RiveViewModel asset. We later add the view() modifier which turns
    // it into a proper View.
    ...
    var body: some View {
        VStack {
            ...
            .shadow(color: Color("Background 2").opacity(0.3), radius: 20, x: 0, y: 5)
    ...
    // The five tabs which are then styled above in the HStack.
